  ...
  return (
    <>
      ...
      <div className="">       
        ...
        <button onClick={hadleAddToCart} className="ml-2  p-1.5 transition ease-in duration-200 rounded-full hover:bg-gray-800 hover:text-white border-2 border-gray-900 focus:outline-none">
          Add to cart
            </button>
            </div>
        </>
